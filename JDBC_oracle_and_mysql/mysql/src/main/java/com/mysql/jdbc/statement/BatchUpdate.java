package com.mysql.jdbc.statement;
...
public class BatchUpdate {
    ...
    public static void main(String[] args) {
        ...
        try (Connection conn = DriverManager.getConnection(
            ...
            // insert
            statement.addBatch(generateInsert("omputer", new BigDecimal(1000)));

            // insert
            statement.addBatch(generateInsert("jane", new BigDecimal(2000)));

            // update
            statement.addBatch(updateSalaryByName("Julie", new BigDecimal(888)));
